...
class Step3 extends StepBase {
    constructor(addCardInstance, utils, globalConfig, stepConfig, state, stepNumber) {
        super(addCardInstance, utils, globalConfig, stepConfig, state, stepNumber);
        ...
        this.modalSearchDebounce = this.utils.debounce(this._performModalSearch.bind(this), 500); // Increased debounce for potentially more complex search

        logger.info("Step3 constructed.");
    }

    init() {
        super.init(); // Call base init if it does anything
    ...
    activate() {
        ...
        if (this.state.selectedCard && !this.state.step3DataInitialized) { // Add a flag to prevent re-init on back navigation
            this._autoPopulateFromSelectedCard();
            this.addCardInstance.state.step3DataInitialized = true; // Use main state to persist this flag
        }
...
// Add to your main CSS or a <style> tag on the page for the multi-select height
// Adjust the height as needed.
/*
.custom-multiselect-height {
    height: 100px; // Or any other suitable height
}
*/
